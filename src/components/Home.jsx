...
export default function Home() {
  return (
    <>
      {/* SEO */}
      <Helmet>
        <title>Honey Farm Rwanda | Organic Honey 🐝</title>

        <meta
          name="description"
          content="Pure natural honey from Rwanda. Healthy bee products delivered fresh from Honey Farm."
        />

        <meta
          name="keywords"
          content="honey Rwanda, organic honey, beeswax, bee products, natural honey"
        />
